...
gum spin --spinner line --title "Installing gh cli" -- sleep 30 |
...
gum spin --spinner line --title "Cloning Neovim" -- sleep 30 |
...
gum spin --spinner line --title "Fetching the Neovim configuration" -- sleep 30 | 
    git clone https://github.com/egomezbpedro/nvim-conf.git ~/.config/nvim \
    git clone --depth 1 https://github.com/wbthomason/packer.nvim\ ~/.local/share/nvim/site/pack/packer/start/packer.nvim
gum spin --spinner line --title "Fetching system configuration" -- sleep 30 |
    git clone https://github.com/egomezbpedro/dotfiles.git ~/.dotfiles
gum spin --spinner line --title "Fetching tmux configuration" -- sleep 30 |
    git clone https://github.com/tmux-plugins/tpm ~/.tmux/plugins/tpm
gum spin --spinner line --title "Cleaning" -- sleep 30 |
    rm ~/.zshrc \
    stow -d ~/.dotfiles -t ~/ \
    su - ${USER}
fi
